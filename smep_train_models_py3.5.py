...
model.add(Conv1D(filters=64, kernel_size=3, activation='relu',padding='same',kernel_initializer='random_uniform', kernel_constraint=max_norm(3),bias_constraint=max_norm(3)))
model.add(MaxPooling1D(pool_size=2))
model.add(Dropout(0.20))
model.add(Conv1D(filters=128, kernel_size=3, activation='relu',padding='same',kernel_initializer='random_uniform', kernel_constraint=max_norm(3),bias_constraint=max_norm(3)))
model.add(MaxPooling1D(pool_size=2))
model.add(Dropout(0.20))

model.add(Flatten())

model.add(Dense(64, activation='relu',kernel_initializer='random_uniform', kernel_constraint=max_norm(3),bias_constraint=max_norm(3)))
model.add(Dropout(0.20))
model.add(Dense(32, activation='relu',kernel_initializer='random_uniform', kernel_constraint=max_norm(3),bias_constraint=max_norm(3)))
model.add(Dropout(0.20))
